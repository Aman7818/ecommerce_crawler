...
#
#     def get_driver(self):
#         service = Service(r"C:\Users\Aman\Downloads\chromedriver-win64\chromedriver.exe")  # Replace with your path
...
#         self.product_urls[domain] = list(links)
#
...
class WebDriverSetup:
    ...
    def get_driver(self):
        # service = Service(r"C:\Users\Aman\Downloads\chromedriver-win64\chromedriver-win64\chromedriver.exe")  # Replace with your actual path
